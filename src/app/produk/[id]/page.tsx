        ...
        <div className={styles.grid}>
          ...
          <div className={styles.imageSection}>
            ...
            <div className={styles.badges}>
              ...
              {product.stock > 0 && product.stock <= 3 ? (
                <span className={`badge badge-danger`} style={{ animation: 'pulse 2s infinite' }}>🔥 Sisa {product.stock} aja!</span>
              ) : product.stock > 3 ? (
          ...
          <div className={styles.detailsSection}>
            ...
            <div className={styles.priceWrap}>
              <span className={styles.priceLabel}>Estimasi Harga</span>
              ...
              <div className={styles.urgencyAlert}>
                ⏳ Harga emas bisa berubah sewaktu-waktu. Tanya admin untuk harga pasti hari ini.
              </div>
            </div>

            <div className={styles.specsBox}>
              <h3 className={styles.specsTitle}>Spesifikasi Produk</h3>
              <div className={styles.specRow}>
                <span className={styles.specLabel}>Material</span>
                <span className={styles.specValue} style={{ color: isEmas ? 'var(--gold-primary)' : '#cbd5e1' }}>{product.material}</span>
              </div>
              <div className={styles.specRow}>
              ...
              <div className={styles.specRow}>
                <span className={styles.specLabel}>Berat Estimasi</span>
                <span className={styles.specValue}>{product.weight} Gram</span>
              </div>
            </div>
            ...
            <div className={styles.actions}>
              ...
              <div className={styles.guarantee}>
                ...
                <span>Garansi Buyback 100% Sesuai Harga Pasar</span>
              </div>
            </div>
          </div>
        </div>
